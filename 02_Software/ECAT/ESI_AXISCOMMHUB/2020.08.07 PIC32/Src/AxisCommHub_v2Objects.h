...
#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
/**
...
TOBJ1600;
#endif //#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
...
* SubIndex 19 - Reference to 0x6001.4<br>
*/
...
{ DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READ }}; /* Subindex19 - Reference to 0x6001.4 */
...
UINT32 SI19; /* Subindex19 - Reference to 0x6001.4 */
} OBJ_STRUCT_PACKED_END
TOBJ1A00;
#endif //#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
...
#if defined(_AXIS_COMM_HUB_V2_) && (_AXIS_COMM_HUB_V2_ == 1)
={19,0x60000110,0x60000210,0x60000310,0x60000410,0x60000510,0x60000610,0x60000710,0x60000810,0x60000910,0x60000A10,0x60000B10,0x60000C10,0x60000D10,0x60000E10,0x60000F10,0x60010110,0x60010210,0x60010310,0x60010410}
#endif
;
/** @}*/
...
* <br>
* SubIndex 0<br>
* SubIndex 1 - TEMPERATURE1<br>
* SubIndex 2 - TEMPERATURE2<br>
* SubIndex 3 - TEMPERATURE3<br>
* SubIndex 4 - TEMPERATURE4<br>
* SubIndex 5 - TEMPERATURE5<br>
* SubIndex 6 - TEMPERATURE6<br>
* SubIndex 7 - TEMPERATURE7<br>
* SubIndex 8 - TEMPERATURE8<br>
* SubIndex 9 - TEMPERATURE9<br>
* SubIndex 10 - TEMPERATURE10<br>
* SubIndex 11 - TEMPERATURE11<br>
* SubIndex 12 - TEMPERATURE12<br>
* SubIndex 13 - TEMPERATURE13<br>
* SubIndex 14 - TEMPERATURE14<br>
* SubIndex 15 - TEMPERATURE15<br>
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6000[] = {
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex1 - TEMPERATURE1 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex2 - TEMPERATURE2 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex3 - TEMPERATURE3 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex4 - TEMPERATURE4 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex5 - TEMPERATURE5 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex6 - TEMPERATURE6 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex7 - TEMPERATURE7 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex8 - TEMPERATURE8 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex9 - TEMPERATURE9 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex10 - TEMPERATURE10 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex11 - TEMPERATURE11 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex12 - TEMPERATURE12 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex13 - TEMPERATURE13 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex14 - TEMPERATURE14 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }}; /* Subindex15 - TEMPERATURE15 */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
UINT16 TEMPERATURE1; /* Subindex1 - TEMPERATURE1 */
UINT16 TEMPERATURE2; /* Subindex2 - TEMPERATURE2 */
UINT16 TEMPERATURE3; /* Subindex3 - TEMPERATURE3 */
UINT16 TEMPERATURE4; /* Subindex4 - TEMPERATURE4 */
UINT16 TEMPERATURE5; /* Subindex5 - TEMPERATURE5 */
UINT16 TEMPERATURE6; /* Subindex6 - TEMPERATURE6 */
UINT16 TEMPERATURE7; /* Subindex7 - TEMPERATURE7 */
UINT16 TEMPERATURE8; /* Subindex8 - TEMPERATURE8 */
UINT16 TEMPERATURE9; /* Subindex9 - TEMPERATURE9 */
UINT16 TEMPERATURE10; /* Subindex10 - TEMPERATURE10 */
UINT16 TEMPERATURE11; /* Subindex11 - TEMPERATURE11 */
UINT16 TEMPERATURE12; /* Subindex12 - TEMPERATURE12 */
UINT16 TEMPERATURE13; /* Subindex13 - TEMPERATURE13 */
UINT16 TEMPERATURE14; /* Subindex14 - TEMPERATURE14 */
UINT16 TEMPERATURE15; /* Subindex15 - TEMPERATURE15 */
} OBJ_STRUCT_PACKED_END
TOBJ6000;
#endif //#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
...
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex2 - EVENT */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex3 - ERROR */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }}; /* Subindex4 - CMD-Status */
...
UINT16 EVENT; /* Subindex2 - EVENT */
UINT16 ERROR; /* Subindex3 - ERROR */
UINT16 CMDStatus; /* Subindex4 - CMD-Status */
} OBJ_STRUCT_PACKED_END
TOBJ6001;
#endif //#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
...
* SubIndex 6 - Data5<br>
* SubIndex 7 - Data6<br>
* SubIndex 8 - Command<br>
*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7000[] = {
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex1 - Data0 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex2 - Data1 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex3 - Data2 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex4 - Data3 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex5 - Data4 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex6 - Data5 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }, /* Subindex7 - Data6 */
{ DEFTYPE_UNSIGNED16 , 0x10 , ACCESS_READWRITE | OBJACCESS_RXPDOMAPPING }}; /* Subindex8 - Command */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
UINT16 Data0; /* Subindex1 - Data0 */
UINT16 Data1; /* Subindex2 - Data1 */
UINT16 Data2; /* Subindex3 - Data2 */
UINT16 Data3; /* Subindex4 - Data3 */
UINT16 Data4; /* Subindex5 - Data4 */
UINT16 Data5; /* Subindex6 - Data5 */
UINT16 Data6; /* Subindex7 - Data6 */
UINT16 Command; /* Subindex8 - Command */
} OBJ_STRUCT_PACKED_END
TOBJ7000;
#endif //#ifndef _AXIS_COMM_HUB_V2_OBJECTS_H_
...
/* Object 0x1600 */
{NULL , NULL ,  0x1600 , {DEFTYPE_PDOMAPPING , 8 | (OBJCODE_REC << 8)} , asEntryDesc0x1600 , aName0x1600 , &MasterCMDsProcessDataMapping0x1600 , NULL , NULL , 0x0000 },
/* Object 0x1A00 */
{NULL , NULL ,  0x1A00 , {DEFTYPE_PDOMAPPING , 19 | (OBJCODE_REC << 8)} , asEntryDesc0x1A00 , aName0x1A00 , &InputMapping00x1A00 , NULL , NULL , 0x0000 },
/* Object 0x1C12 */
...
/* Object 0x6001 */
{NULL , NULL ,  0x6001 , {DEFTYPE_RECORD , 4 | (OBJCODE_REC << 8)} , asEntryDesc0x6001 , aName0x6001 , &SystemStatus0x6001 , NULL , NULL , 0x0000 },
/* Object 0x7000 */
{NULL , NULL ,  0x7000 , {DEFTYPE_RECORD , 8 | (OBJCODE_REC << 8)} , asEntryDesc0x7000 , aName0x7000 , &MasterCMDs0x7000 , NULL , NULL , 0x0000 },
/* Object 0xF000 */
...
/** @}*/
#define _AXIS_COMM_HUB_V2_OBJECTS_H_
